  ...
  return (
    <div className="p-2">
      ...
      <div className="mt-1 flex justify-center">
        <div className="relative text-gray-500 focus-within:text-gray-900 mb-8">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center px-3 rounded-r-lg border-gray-300 border-r bg-gray-200">
            <button
              onClick={() => setApiKey(document.getElementById("key").value)}
            >
              Submit
            </button>
          </div>
      ...
      <h4 className="text-center mb-3">
        {/* Token Expire: {date.toLocaleString("th-TH")} */}
      </h4>
      <div className="flex justify-center flex-rows">
        {/* <CopyInput value={session && session.accessToken} /> */}
        <button
          className="w-30 px-3 py-3 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none duration-100 ease-in-out"
          onClick={async () => {
      ...
      <div className="flex justify-center">
        <h1 className="text-yellow-400">{count}</h1>
        <button
